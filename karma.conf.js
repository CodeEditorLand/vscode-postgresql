...
module.exports = (config) => {
	...
	const configuration = {
		...
		files: [
			...
			// RxJs
			{
				pattern: "out/src/views/htmlcontent/lib/js/rxjs/**/*.js",
				included: false,
				watched: false,
			},
			{
				pattern: "out/src/views/htmlcontent/lib/js/rxjs/**/*.js.map",
				included: false,
				watched: false,
			},
			...
			{
				pattern:
					"out/src/views/htmlcontent/lib/js/angular2-slickgrid/**/*.js",
				included: false,
				watched: false,
			},
			{
				pattern:
					"out/src/views/htmlcontent/lib/js/angular2-slickgrid/**/*.js.map",
				included: false,
				watched: false,
			},

			{
				pattern: "out/src/views/htmlcontent/lib/js/json.js",
				included: false,
				watched: false,
			},
			...
			// Angular itself
			{
				pattern: "out/src/views/htmlcontent/lib/js/@angular/**/*.js",
				included: false,
				watched: false,
			},
			{
				pattern:
					"out/src/views/htmlcontent/lib/js/@angular/**/*.js.map",
				included: false,
				watched: false,
			},

			{
				pattern: "out/src/views/htmlcontent/lib/js/systemjs.config.js",
				included: false,
				watched: false,
			},
			"karma-test-shim.js",
		...
		proxies: {
			...
			"/base/out/src/views/htmlcontent/src/":
				"/base/out/src/views/htmlcontent/dist/",
		},
		exclude: [],
