...
declare module "~chai/lib/Expect" {
	import type { AssertionStatic } from "~chai/lib/Assertion";
...
declare module "~chai/lib/Utils" {
	import type { Assertion } from "~chai/lib/Assertion";
...
declare module "~chai/lib/Chai" {
	...
	import type * as Assert from "~chai/lib/Assert";
	import type * as A from "~chai/lib/Assertion";
	import type * as Expect from "~chai/lib/Expect";
	import type * as Should from "~chai/lib/Should";
	import type * as Config from "~chai/lib/Config";
	import type * as Utils from "~chai/lib/Utils";
	...
	namespace chai {
		 ...
		 */
		export function use(
			fn: (chai: any, utils: Utils.Utils) => void,
		): typeof chai;
	}
