...
function waitForExtensionToBeActive(resolve): void {
	if (
		typeof vscode.extensions.getExtension("Microsoft.vscode-pgsql") ===
			"undefined" ||
...
suite("Initialization Tests", () => {
	...
	test("Connection manager is initialized properly", function (done): void {
		// Note: this can't be an arrow function (=>), otherwise this.timeout() breaks
