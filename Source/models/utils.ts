...
export function parseTimeString(value: string): number | boolean {
	...
	const ms = Number.parseInt(tempVal[1].substring(0, msStringEnd), 10);
	...
	const h = Number.parseInt(tempVal[0], 10);
	const m = Number.parseInt(tempVal[1], 10);
	const s = Number.parseInt(tempVal[2], 10);
