...
describe("Messages Context Menu", () => {
	...
	describe("initialization", () => {
		...
		beforeEach(() => {
			fixture =
				TestBed.createComponent<MessagesContextMenu>(
					MessagesContextMenu
				);
		...
		it("should be hidden", () => {
			expect(
				ele.firstElementChild.className.indexOf("hidden")
			).not.toEqual(-1);
		});
	});
	...
	describe("basic behavior", () => {
		...
		it("shows correctly", () => {
			...
			fixture.detectChanges();
			expect(ele.firstElementChild.className.indexOf("hidden")).toEqual(
				-1
			);
			expect(ele.firstElementChild.childElementCount).toEqual(
				1,
				"expect 1 menu items to be present"
			);
		});
