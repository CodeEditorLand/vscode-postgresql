...
import type { Runtime } from "../models/platform";
import type { IConfig, IStatusView } from "./interfaces";
import type ServiceDownloadProvider from "./serviceDownloadProvider";
...
export default class ServerProvider {
	...
	public getOrDownloadServer(runtime: Runtime): Promise<string> {
		...
		return new Promise<string>((resolve, reject) => {
			return this.getServerPath(runtime)
				.then((result) => {
					if (result === undefined) {
